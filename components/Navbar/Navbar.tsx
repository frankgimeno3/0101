...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-gray-500 bg-opacity-20 backdrop-filter backdrop-blur-lg flex items-center justify-between p-4 md:text-xs xl:text-base ">
      ...
      <div className="flex items-center space-x-4 xl:pr-5 md:pr-1">
        <Link href="/registro" passHref>
          <span className="text-gray-200 hover:cursor-pointer hover:text-gray-800">Registro</span>
        </Link>
