...
const Navbar: React.FC = () => {
  return (
    <nav className="flex items-center justify-between bg-gray-200 p-4 md:text-xs xl:text-base border-b-2 border-gray-500">
      ...
      <div className="flex items-center space-x-4 xl:pr-5 md:pr-1">
        <Link href="/registro" passHref>
          <span className="text-gray-500 hover:cursor-pointer hover:text-gray-800">Registro</span>
        </Link>
